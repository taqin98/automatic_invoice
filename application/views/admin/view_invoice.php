            		...
            		<table class="table">
            			<thead>
            				<tr>
            					...
            					<th scope="col" width="150px">Sub total</th>
            				</tr>
            			</thead>
            			<tbody>
            			<?php
            				$total = 0;
            				$nomor = 0;
            				foreach ($data as $key): $total+=$key->qty*$key->harga; ?>
            				<tr>
            					<th scope="row"><?php $nomor++; echo $nomor; ?></th>
            					<td><img height="100px" src="<?= base_url('assets/data/') . $key->foto; ?>"></td>
            					<td><?= $key->panjang; ?> cm</td>
            					<td><?= $key->lebar; ?> cm</td>
            					<td><?= $key->tinggi; ?> cm</td>
            					<td><?= $key->qty; ?></td>
            					<td><?= $Invoice->rupiah($key->harga); ?></td>
            					<td><?= $Invoice->rupiah($key->qty*$key->harga); ?></td>
            				</tr>
            			<?php endforeach; ?>
            			<tr>
            				<td colspan="6"></td>
            				<td>Total</td>
            				<td><?= $Invoice->rupiah($total); ?></td>
            			</tr>
            			</tbody>
            		</table>
            	</div>
