...
<body>
    ...
    <div id="appCapsule">
        <div class="section full mt-2">
            <div class="section-title">Input Pelanggan</div>
             
            <div class="wide-block pb-1 pt-1">
                <form method="POST" enctype="multipart/form-data" action="<?= base_url('pelanggan/input') ?>">
                	...
                	<div class="form-group boxed">
                		<div class="input-wrapper">
                			<label class="label" for="name5">Nomor Hp/WA</label>
