<?php
if($this->session->userdata('level') == NULL) redirect('users','refresh')
?>
<html lang="en">
<head>
                ...
                <form method="POST" enctype="multipart/form-data" action="<?= base_url('product/input'); ?>">
                    <div class="row">
                        <div class="form-group col p-0">
                            <img src="<?= base_url('assets/images/80x80.png'); ?>" width="80px" height="80px" id="showgambar">
                        </div>
                        <div class="form-group col p-0">
                            <div class="input-wrapper">
                                <input type="file" name="upload_file" id="actual-btn" hidden>
                                <label class="labelfoto" for="actual-btn">
                                    <ion-icon name="image-outline"></ion-icon>
                                </label><br>
                                <span id="file-chosen">Upload foto</span>
                            </div>
                        </div>
                        <div class="form-group col p-0">
                        <div class="input-wrapper">
                            <label class="label" for="name5">Nama Produk</label>
                    ...
                    <div class="row">
                        <div class="form-group col p-1">
                            <div class="input-wrapper">
                                <label class="label" for="name5">Panjang</label>
                        ...
                        <div class="form-group col p-1">
                            <div class="input-wrapper">
                                <label class="label" for="name5">Lebar</label>
                        ...
                        <div class="form-group col p-1">
                            <div class="input-wrapper">
                                <label class="label" for="name5">Tinggi</label>
                    ...
                    <div class="row">
                        <div class="form-group col p-1">
                            <div class="input-wrapper">
                                <label class="label" for="name5">Keterangan</label>
                                <input type="text" name="des" class="form-control" placeholder="Keterangan" required="">
                                <i class="clear-input">
                                    <ion-icon name="close-circle" role="img" class="md hydrated" aria-label="close circle"></ion-icon>
                                </i>
                            </div>
